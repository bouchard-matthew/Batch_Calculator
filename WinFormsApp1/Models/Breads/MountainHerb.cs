...
{
    internal class MountainHerb : Recipe
    {
        public MountainHerb() : base()
        {
            Ingredients = new IIngredient[]
            {
                ...
                Factory.Factory.CreateIngredient("dill", 1, Units.Tsp),
                Factory.Factory.CreateIngredient("garlicPowder", 0.25, Units.Tsp),
